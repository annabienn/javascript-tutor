...
function studyNotesForModule(module) {
  const notes = {
    ...
    storage: {
      focus: "Η αποθήκευση στον browser βοηθά την εφαρμογή να κρατά προσωρινή κατάσταση, αλλά δεν αντικαθιστά τη βάση δεδομένων για μόνιμη πρόοδο και λογαριασμούς.",
      method: "Δώσε προσοχή στη διαφορά sessionStorage, localStorage και server storage. Εκτέλεσε τα παραδείγματα με JSON.stringify και JSON.parse για να δεις πώς αποθηκεύονται objects.",
      beforeQuiz: "Είσαι έτοιμος όταν μπορείς να εξηγήσεις τι καθαρίζεται στην αποσύνδεση και γιατί η πρόοδος αποθηκεύεται στη SQLite.",
    },
    quality_project: {
      focus: "Μία ολοκληρωμένη εφαρμογή χρειάζεται ροή χρήστη, επαρκές περιεχόμενο, αξιολόγηση, αναφορές, αποθήκευση, καθαρό UI και τεκμηρίωση.",
      method: "Μελέτησε την εφαρμογή σαν προϊόν: ποια είναι η πρώτη οθόνη, πώς μπαίνει ο χρήστης, πώς αξιολογείται και πώς βλέπει την πρόοδό του.",
      beforeQuiz: "Είσαι έτοιμος όταν μπορείς να φτιάξεις checklist ελέγχων πριν από την παράδοση.",
    },
  };
...
function extendedTheoryForModule(module) {
  const theory = {
    ...
    storage: [
      ["Βασική ιδέα", "Το sessionStorage και το localStorage κρατούν δεδομένα στον browser. Το πρώτο είναι προσωρινό για τη συνεδρία, ενώ το δεύτερο διατηρείται περισσότερο. Για πραγματική πρόοδο χρήστη, όμως, χρειάζεται server ή βάση δεδομένων."],
      ["JSON", "Τα objects δεν αποθηκεύονται απευθείας στο storage. Με JSON.stringify γίνονται κείμενο και με JSON.parse επανέρχονται σε JavaScript object."],
      ["Αποσύνδεση", "Στην αποσύνδεση πρέπει να καθαρίζεται η ενεργή συνεδρία και ο χρήστης να επιστρέφει στη σελίδα εισόδου/εγγραφής. Αυτό προστατεύει την προσωπική μαθησιακή περιοχή."],
      ["Πριν το quiz", "Να μπορείς να αποφασίσεις ποια δεδομένα αποθηκεύονται προσωρινά στον browser και ποια πρέπει να μένουν στη SQLite."],
    ],
    quality_project: [
      ["Βασική ιδέα", "Ολοκληρωμένο προϊόν σημαίνει ότι όλες οι βασικές λειτουργίες συνεργάζονται: αρχική σελίδα, σύνδεση, μάθημα, quiz, αποθήκευση, αναφορές και αποσύνδεση."],
      ["Ποιότητα", "Δεν αρκεί να υπάρχει κώδικας. Χρειάζεται σαφής πλοήγηση, σωστά μηνύματα, responsive εμφάνιση, έλεγχος λαθών και ομαλή ροή από τη μία λειτουργία στην άλλη."],
      ["Τεκμηρίωση", "Η τεκμηρίωση εξηγεί τι υλοποιήθηκε, ποια αρχεία υπάρχουν, πώς τρέχει η εφαρμογή και πώς καλύπτονται οι απαιτήσεις της εκφώνησης."],
      ["Πριν το quiz", "Να μπορείς να συνδέσεις κάθε απαίτηση της εργασίας με συγκεκριμένη λειτουργία της εφαρμογής."],
    ],
  };
